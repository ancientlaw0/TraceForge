...
class Patcher:
    ...
    def patch(self, target: Any, attribute: str) -> None:

        patch_key = (id(target), attribute)
        ...
        if inspect.iscoroutinefunction(original):
            ...
            async def wrapper(*args, **kwargs):
                ...
                try:
                    model, prompt = self.integration.extract_request(args, kwargs)
                except Exception:
                ...
                try:
                    ...
                    try:
                        error_message = self.integration.extract_error(error)
                    except Exception:
                ...
                try:
                    (
                        ...
                        output_tokens,
                        metadata,
                    ) = self.integration.extract_response(response)

                    cost = self.integration.calculate_cost(
                        model=model,
